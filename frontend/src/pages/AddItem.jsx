...
const AddItem = () => {
  ...
  const handleCreate = async () => {
    ...
    const parsedData = { ...formData, ItemPrice: parseFloat(formData.ItemPrice || 0) };
  ...
  return (
    <div>
      <h2 style={{ marginBottom: '30px', fontSize: '24px' }}>Add New Item</h2>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '30px', maxWidth: '800px' }}>
        ...
        <div>
          <label style={labelStyle}>Customer Selling Price</label>
          <input 
            type="number" 
            name="ItemPrice"
